...
halting. The problem: resolve either containment between CL and P. Concretely,
...
results: the Cook–Mertz Tree Evaluation algorithm (see problem
tree-evaluation-log-space) and, through it, Williams' TIME[t] ⊆
SPACE[sqrt(t log t)] (see problem time-space-sqrt-simulation). Meanwhile the
