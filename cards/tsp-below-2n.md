...
hypotheses: [ETH, SETH]
record: "O(2^n n^2) time (general weights); O(1.9999^n) for bipartite TSP assuming quadratic-time matrix multiplication"
record_ref: "Bellman 1962; Held & Karp 1962. Bipartite: Nederlof, STOC 2020"
...
exactly S and ending at v — runs in O(2^n n^2) time and has not been beaten
for general weighted TSP in over sixty years. The contrast with the
...
weighted TSP, nothing below 2^n·poly is known under any assumption. On the
...
algorithm or vice versa — an equivalence would merge this card with the Set
